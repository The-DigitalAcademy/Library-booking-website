...
def store_books(books):
    ...
    for book in books:
        ...
        cover_url = book['volumeInfo'].get('imageLinks', {}).get('thumbnail', 'No cover')
        ...
        # Insert book
        cur.execute(
            "INSERT INTO books (book_id, title, description, availability, published_date, category_id, author_id, cover_url) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
            (book['id'], title, description, True, published_date, category_id, author_id, cover_url)
        )
